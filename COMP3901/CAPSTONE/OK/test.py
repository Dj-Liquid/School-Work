...
receiver_emails=["robinsond993@gmail.com","campusrepairs1@gmail.com","sici3902@gmail.com","dttd2266@gmail.com"]
receiver_emails.append(A)
                ...
                for id in numpy_ids:
                    ...
                    if(clID[b] == 0):#TESTING IF HUMAN
                         ...
                         if(CompLoc(co_ordinates,danger_zone)):
                             ...
                             db_manager.update_count(new_info)
                             #count_area = db_manager.get_count([int(id)])
                         ...
                         ###REVISIT
                         if((not zone_test)and(notify_count==0)):#USE ZONE VARIABLE IN DATABASE
                              notify_count=1
